...
def ForFile(path,boxsize,path2,snapnum):
    ...
    GID,BLOBNUM,UV_F115W_ST,UV_F115W_STNB,SUM_ST_W0,SUM_ST_WO0,SUM_STNB_W0,SUM_STNB_WO0 = np.loadtxt(path).T
    ...
    def plot_lf_sfr():
        root=galspy.NavigationRoot(path2)
        sfr = root.PIG(snapnum).FOFGroups.StarFormationRate()
...
ForFile("/mnt/home/student/cranit/RANIT/Repo/galspy/scripts/SPM2/data/blob_UV150.txt",150,
        "/mnt/home/student/cranit/NINJA/simulations/L150N2040/SNAPS/",43)
ForFile("/mnt/home/student/cranit/RANIT/Repo/galspy/scripts/SPM2/data/blob_UV250.txt",250,
        "/mnt/home/student/cranit/NINJA/simulations/L250N2040/SNAPS/",42)
