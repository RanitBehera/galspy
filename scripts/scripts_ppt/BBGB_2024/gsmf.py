...
# ASTRID OVERPLOT
# z=10
x = [7.054347826086957, 7.282608695652174, 7.983695652173913, 8.440217391304348, 8.733695652173912, 9.027173913043478, 9.369565217391305]
y = [-2.8157894736842106, -3.0526315789473686, -4.052631578947368, -4.973684210526316, -5.552631578947368, -6.052631578947368, -7.2105263157894735]
z10.plot(10.**np.array(x)*0.6736,10.**np.array(y),c='k',zorder=-10,ls='--')
# z=9
x = [7.059459459459459, 7.351351351351351, 7.772972972972973, 8.583783783783783, 9.021621621621621, 9.32972972972973, 9.686486486486487]
y = [-2.3947368421052633, -2.6578947368421053, -3.210526315789474, -4.421052631578947, -5.2894736842105265, -5.815789473684211, -6.921052631578947]
z9.plot(10.**np.array(x)*0.6736,10.**np.array(y),c='k',zorder=-10,ls='--')
# z=8
x = [7.021739130434782, 7.7228260869565215, 8.48913043478261, 9.369565217391305, 9.728260869565217, 10.070652173913043, 10.396739130434783]
y = [-2.0263157894736845, -2.68421052631579, -3.6842105263157894, -5.078947368421053, -5.815789473684211, -6.842105263157895, -7.2631578947368425]
z8.plot(10.**np.array(x)*0.6736,10.**np.array(y),c='k',zorder=-10,ls='--')
# z=7
x = [7.021739130434782, 7.413043478260869, 7.9021739130434785, 8.456521739130435, 8.880434782608695, 9.23913043478261, 9.66304347826087, 9.972826086956522, 10.41304347826087, 10.755434782608695]
y = [-1.7105263157894743, -2.0263157894736845, -2.5263157894736845, -3.105263157894737, -3.605263157894737, -4.105263157894737, -4.7368421052631575, -5.342105263157895, -6.342105263157895, -6.947368421052632]
z7.plot(10.**np.array(x)*0.6736,10.**np.array(y),c='k',zorder=-10,ls='--')
# z=6
x = [7.054347826086957, 7.592391304347826, 8.130434782608695, 8.782608695652174, 9.33695652173913, 9.826086956521738, 10.266304347826086, 10.73913043478261, 11.097826086956522]
y = [-1.450980392156863, -1.8954248366013067, -2.3398692810457513, -2.9934640522875817, -3.6209150326797386, -4.300653594771242, -4.980392156862745, -5.921568627450981, -6.784313725490196]
z6.plot(10.**np.array(x)*0.6736,10.**np.array(y),c='k',zorder=-10,ls='--')
# z=5
x = [7.043243243243243, 7.578378378378378, 8.12972972972973, 8.713513513513513, 9.313513513513513, 9.913513513513514, 10.4, 11.08108108108108, 11.437837837837838, 11.778378378378378]
y = [-1.189542483660131, -1.5816993464052285, -1.973856209150327, -2.4705882352941178, -3.045751633986928, -3.7516339869281046, -4.483660130718954, -5.660130718954249, -6.784313725490196, -7.228758169934641]
z5.plot(10.**np.array(x)*0.6736,10.**np.array(y)*0.6736**2,c='k',zorder=-10,ls='--')
