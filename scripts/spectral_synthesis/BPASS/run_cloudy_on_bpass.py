...
SED_FN  = [cld.removesuffix(".sed") for cld in os.listdir(OUTDIR) if os.path.isfile(OUTDIR+os.sep+cld) and cld.endswith(".sed")]
...
script = ConcurrentCloudyRunner(INFILE,51)
