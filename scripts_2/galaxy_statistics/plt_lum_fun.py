...
def Plot(i,BOX,Z,boxsize_mpc):
    ...
    ax.set_xlim(-25,-18)
    xticks = np.array([-24,-23,-22,-21,-20,-19])     # In log10 scale
...
line_nb = mlines.Line2D([], [], color='orange',ls='-',marker=' ',markersize=8, label="+ Nebular (Primordial)")
...
leg=axs[0].legend(handles=[adams,donnan,harikane],fontsize=12, loc='upper right',ncol=1,frameon=False,bbox_to_anchor=(1,1),markerfirst=False)
